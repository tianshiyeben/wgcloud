...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require([ctx+'/static/echarts-2.2.7/doc/example/theme/' + theme], function(tarTheme){
                curTheme = tarTheme;
        ...
        function loadedListener() {
            ...
            require.config({
                packages: [
                    {
                        name: 'echarts',
                        location: ctx+'/static/echarts-2.2.7/src',
                        main: 'echarts'
                    },
                    {
                        name: 'zrender',
...
function launchExample() {
    ...
    require(
        [
            'echarts',
            ctx+'/static/echarts-2.2.7/doc/example/theme/' + hash.replace('-en', ''),
            'echarts/chart/line',
            'echarts/chart/bar',
