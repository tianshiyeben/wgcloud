    ...
    <!-- Content -->
        ...
        <div class='panel panel-default'>
          <div class='panel-heading'>
            ...
            请先在HOST服务器查看进程ID后再添加。PS：每次应用重启后进程ID都可能变化，所以需要在这同步修改
          </div>
          <div class='panel-body'>
            <form class='form-horizontal' action="${ctx }/sys/app/save" onsubmit="return dosubmit()" method="post">
              <fieldset>
                ...
                <div class='form-group'>
                  <label class='col-lg-2 control-label'>进程ID<font color="red">*</font></label>
                  <div class='col-lg-10'>
                    <input  id="appPid" name="appPid" value="" autocomplete="off" maxlength="12" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" class='form-control' placeholder='如26365' type='text'/>
                  </div>
                </div>
                <div class='form-group'>
                  <label class='col-lg-2 control-label'>进程名称<font color="red">*</font></label>
                  <div class='col-lg-10'>
                    <input  id="appName" name="appName" value="" autocomplete="off" maxlength="30" class='form-control' placeholder='如网站后台服务' type='text'/>
                  </div>
                </div>
              </fieldset>
