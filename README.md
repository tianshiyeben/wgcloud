...
WGCLOUD基于微服务springboot架构开发，是轻量高性能的分布式监控系统，核心采集指标包括：**主机系统信息，ES集群状态，CPU状态，CPU温度，大屏可视化，内存状态，业务数据监控(mysql，oracle，pgsql等)，服务接口检测，应用进程管理，磁盘空间和IO监控，硬盘smart健康检测，系统负载监控，网络拓扑图，端口监控，日志文件监控，docker监控，Web SSH，堡垒机，告警信息（邮件微信钉钉短信等）推送**。[english readme](<./README_en.md>)
